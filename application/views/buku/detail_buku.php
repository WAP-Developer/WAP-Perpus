  ...
  <div class="x_content">
    <div class="row" >
      <div class="col-sm-3 col-md-3">
        <div class="thumbnail" style="height: auto; position: relative; lef: 165%; width: auto;">
          ...
          <div class="caption">
            ...
            <p>
              ...
              <?=anchor('peminjaman/tambah_pinjam/' . $id, ' Booking' , ['class' => "btn btn-succes', 'role' => 'button'])?>
            </p>
          </div>
        </div>
      </div>
