...
<div class="form-group">
  ...
  <input type="date" name="dari" value="<?php echo set_value('sampai'); ?>" class="form-control">
...
<div class="btn-group">
 ...
 <table border="1" class="table table-triped table-hover tablebordered" id="table-datatable">
 <thead>
   <tr>
    <th>No</th>
	<th>Tanggal</th>
